<template>
  <div class="home-container">
    <!-- 顶部导航栏 -->
    <nav class="navbar">
      <div class="nav-brand">SIMCORE</div>
      <div class="nav-links">
        <LanguageSwitcher />
        <a href="https://github.com/666ghj/SimCore" target="_blank" class="github-link">
          ...
          <div class="hero-desc">
            <p>
              <i18n-t keypath="home.heroDesc" tag="span">
                <template #brand><span class="highlight-bold">{{ $t('home.heroDescBrand') }}</span>
    <!-- SimCore -->
    <div style="text-align:center;padding:20px 0">
      <button
        @click="$router.push('/simcore')"
        style="background:#e8523a;color:#fff;border:none;border-radius:10px;padding:12px 32px;font-size:15px;font-weight:700;cursor:pointer;letter-spacing:.5px">
        🔍 SimCore — تحليل ذكي بالوكلاء
      </button>
    </div>
</template>
