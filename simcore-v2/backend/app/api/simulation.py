...
logger = get_logger('simcore.api.simulation')
...
def create_simulation():
    ...
    请求（JSON）：
        {
            ...
            "graph_id": "simcore_xxxx",    // 可选，如不提供则从project获取
    ...
    try:
        ...
        state = manager.create_simulation(
            ...
            platform=data.get('platform', None),  # SimCore: أي منصة مخصصة
        )
