...
MODELS_CATALOG = [
    ...
    {"id": "nararouter", "name": "NaraRouter", "env": "NARAROUTER_API_KEY",
     ...
     "models": ["Claude Sonnet 4.5 (Free)", "Claude Haiku 4.5 (Free)", "GLM 5 (Free)",
                "DeepSeek 3.2 (Free)", "Mistral Large (Free)", "Claude Sonnet 5",
                "Claude Opus 4.8", "Claude Fable 5", "GPT-5.5", "Kimi K2.7 Code",
                "DeepSeek V4 Pro", "Qwen 3.7 Max", "MiMo V2.5 Pro", "MiniMax M3"]},
    {"id": "agentrouter", "name": "AgentRouter", "env": "AGENTROUTER_API_KEY",
     "login": "https://agentrouter.org", "color": "#10B981", "letter": "A",
     "models": ["GLM-4.6 (Free)", "GLM-4.5 Air (Free)", "DeepSeek-V2 Lite (Free)",
                "Qwen2-7B-Instruct (Free)", "Mistral-7B-Instruct (Free)", "Claude Sonnet 4.5",
                "Claude Opus 4.5", "claude-opus-4-6", "GPT-4o", "GPT-5", "Gemini 3 Pro",
                "DeepSeek R1", "deepseek-v3.2", "Qwen3 Coder 480B"]},
    {"id": "aerolink", "name": "AeroLink", "env": "AEROLINK_API_KEY",
     "login": "https://capi.aerolink.lat", "color": "#0EA5E9", "letter": "A",
     "models": ["claude-opus-4-8", "claude-opus-4-7", "claude-fable-5", "claude-sonnet-5",
