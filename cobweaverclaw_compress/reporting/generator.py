"""HTML report generator for CoBWeaverClaw SDK."""
...
def _get_jinja2_template(template_str: str):
    ...
    try:
        ...
        raise ImportError(
            "jinja2 is required for report generation. Install with: pip install cobweaverclaw_compress[reports]"
        ) from e
...
<head>
    ...
    <title>CoBWeaverClaw Report - {{ generated_at }}</title>
    <style>
        * {
...
<body>
    <div class="container">
        <header>
            <h1>CoBWeaverClaw Context Analysis Report</h1>
        ...
        <footer>
            Generated by CoBWeaverClaw SDK v0.1.0
        </footer>
    </div>
</body>
</html>
...
def _generate_recommendations(
    ...
    if stats["total_tokens_saved"] > 0:
        ...
        recommendations.append(
            {
                "title": "Get Started",
                "description": "No optimizations applied yet. Try setting cobweaverclaw_compress_mode='optimize' "
