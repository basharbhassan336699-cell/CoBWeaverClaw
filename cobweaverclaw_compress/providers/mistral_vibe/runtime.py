...
from cobweaverclaw_compress.providers.codex import proxy_base_url as codex_proxy_base_url
from cobweaverclaw_compress.proxy.project_context import with_project_prefix
...
def build_launch_env(
    ...
    as a JSON array. When routing through CoBWeaverClaw, we set the mistral provider's
    ...
    # NOTE: With a persistent CoBWeaverClaw deployment (`cobweaverclaw_compress install`), the proxy
    ...
    # Build the providers JSON with mistral provider pointing to CoBWeaverClaw proxy
