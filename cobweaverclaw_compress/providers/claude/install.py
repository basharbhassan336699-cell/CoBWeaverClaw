...
from cobweaverclaw_compress.install.paths import claude_settings_path
...
def build_install_env(*, port: int, backend: str) -> dict[str, str]:
    ...
    # The install env is cobweaverclaw_compress-managed and reverted on uninstall, so it is
