...
from cobweaverclaw_compress.install.models import DeploymentManifest, ManagedMutation
from cobweaverclaw_compress.providers.aider.install import build_install_env as _build_aider_install_env
from cobweaverclaw_compress.providers.claude.install import (
...
from cobweaverclaw_compress.providers.codex.install import (
    apply_provider_scope as _apply_codex_provider_scope,
)
from cobweaverclaw_compress.providers.codex.install import build_install_env as _build_codex_install_env
from cobweaverclaw_compress.providers.codex.install import (
    revert_provider_scope as _revert_codex_provider_scope,
)
from cobweaverclaw_compress.providers.copilot.install import (
    build_install_env as _build_copilot_install_env,
)
from cobweaverclaw_compress.providers.cortex_code.install import (
    build_install_env as _build_cortex_code_install_env,
)
from cobweaverclaw_compress.providers.cursor.install import build_install_env as _build_cursor_install_env
from cobweaverclaw_compress.providers.openclaw.install import (
    apply_provider_scope as _apply_openclaw_provider_scope,
)
from cobweaverclaw_compress.providers.openclaw.install import (
    revert_provider_scope as _revert_openclaw_provider_scope,
)
from cobweaverclaw_compress.providers.opencode.install import (
    apply_provider_scope as _apply_opencode_provider_scope,
)
from cobweaverclaw_compress.providers.opencode.install import build_install_env as _build_opencode_install_env
from cobweaverclaw_compress.providers.opencode.install import (
