"""Google Gemini provider for CoBWeaverClaw SDK.

Supports Google's Gemini models through two interfaces:
1. OpenAI-compatible endpoint (recommended for CoBWeaverClaw)
...
Usage:
    ...
    from cobweaverclaw_compress import GoogleProvider
...
from cobweaverclaw_compress.models.registry import ModelRegistry
from cobweaverclaw_compress.tokenizers import EstimatingTokenCounter
