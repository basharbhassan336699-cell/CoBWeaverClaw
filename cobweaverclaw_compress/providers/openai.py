"""OpenAI provider implementation for CoBWeaverClaw SDK.
...
def _load_custom_model_config() -> dict[str, Any]:
    ...
    if env_config:
        try:
            ...
            logger.debug("Loaded custom OpenAI model config from COBWEAVERCLAW_MODEL_LIMITS")
...
class OpenAIProvider(Provider):
    ...
    Custom Model Configuration:
        ...
        1. Environment variable (JSON string):
           export COBWEAVERCLAW_MODEL_LIMITS='{"openai": {"context_limits": {"my-model": 128000}}}'
    ...
    def get_context_limit(self, model: str) -> int:
        ...
        3. COBWEAVERCLAW_MODEL_LIMITS environment variable
        4. ~/.cobweaverclaw_compress/models.json config file
