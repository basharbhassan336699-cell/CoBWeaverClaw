...
Parsers are optional dependencies (``pip install cobweaverclaw_compress-ai[spreadsheet]``) and
...
def _load_xlsx(path: Path) -> dict[str, str]:
    try:
        ...
        raise ImportError(
            ...
            "Install it with: pip install cobweaverclaw_compress-ai[spreadsheet]"
        ) from e
