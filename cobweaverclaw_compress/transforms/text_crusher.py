...
Thin Python wrapper over the native ``cobweaverclaw_compress._core.TextCrusher``. The
algorithm (sentence scoring with the SHARED BM25 relevance scorer + global
word-shingle near-dup suppression) lives in Rust (``crates/cobweaverclaw_compress-core``),
...
from cobweaverclaw_compress._core import TextCrusher as _RustTextCrusher
from cobweaverclaw_compress._core import TextCrusherConfig as _RustTextCrusherConfig
