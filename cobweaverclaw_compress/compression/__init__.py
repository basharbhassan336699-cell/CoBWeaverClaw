...
Quick Start:
    ...
    from cobweaverclaw_compress.compression import UniversalCompressor, UniversalCompressorConfig
...
from cobweaverclaw_compress.compression.detector import ContentType, MagikaDetector
from cobweaverclaw_compress.compression.masks import StructureMask
from cobweaverclaw_compress.compression.universal import (
    CompressionResult,
    UniversalCompressor,
