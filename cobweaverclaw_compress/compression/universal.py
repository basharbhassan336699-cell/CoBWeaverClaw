...
from cobweaverclaw_compress.compression.detector import (
    ContentType,
    DetectionResult,
    FallbackDetector,
    get_detector,
)
from cobweaverclaw_compress.compression.handlers.base import (
    NoOpHandler,
    StructureHandler,
)
from cobweaverclaw_compress.compression.handlers.code_handler import CodeStructureHandler
from cobweaverclaw_compress.compression.handlers.json_handler import JSONStructureHandler
from cobweaverclaw_compress.compression.masks import (
    StructureMask,
    ...
    def _store_in_ccr(self, original: str, compressed: str) -> str | None:
        ...
        try:
            if self._ccr_store is None:
                from cobweaverclaw_compress.cache.compression_store import CompressionStore
...
def compress(content: str, **kwargs: Any) -> CompressionResult:
    ...
    Example:
        >>> from cobweaverclaw_compress.compression import compress
