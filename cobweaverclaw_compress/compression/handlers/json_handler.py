...
from cobweaverclaw_compress.compression.handlers.base import BaseStructureHandler, HandlerResult
from cobweaverclaw_compress.compression.masks import EntropyScore, StructureMask
