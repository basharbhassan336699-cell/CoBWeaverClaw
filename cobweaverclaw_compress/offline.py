"""Air-gap / no-egress master switch (``COBWEAVERCLAW_OFFLINE``).
...
OFFLINE_ENV = "COBWEAVERCLAW_OFFLINE"


def is_offline() -> bool:
    """Return True when ``COBWEAVERCLAW_OFFLINE`` selects fully-offline operation."""
