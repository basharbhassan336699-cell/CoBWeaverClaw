...
class RuntimeKind(str, Enum):
    """Runtime used to execute CoBWeaverClaw."""
...
class ManagedMutation:
    """A reversible change applied by `cobweaverclaw_compress install`."""
...
class DeploymentManifest:
    ...
    image: str = "ghcr.io/chopratejas/cobweaverclaw_compress:latest"
    service_name: str = "cobweaverclaw_compress"
    container_name: str = "cobweaverclaw_compress-persistent"
