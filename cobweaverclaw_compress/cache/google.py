...
class GoogleCacheOptimizer(BaseCacheOptimizer):
    ...
    def prepare_cache_creation(
        ...
        return {
            ...
            "display_name": f"cobweaverclaw_compress-cache-{analysis.content_hash[:8]}",
            "_cobweaverclaw_compress_metadata": {
                "content_hash": analysis.content_hash,
                "token_count": analysis.cacheable_tokens,
                "created_by": "cobweaverclaw_compress",
            },
        }
