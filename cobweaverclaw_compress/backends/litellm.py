"""LiteLLM-based backend for CoBWeaverClaw.
...
# litellm added. Same pattern as `cobweaverclaw_compress/pricing/litellm_pricing.py`.
try:
    import os as _os
        ...
        if provider == "bedrock":
            ...
            if os.environ.get("AWS_SESSION_TOKEN") and importlib.util.find_spec("botocore") is None:
                raise ImportError(
                    ...
                    "pip install 'cobweaverclaw_compress-ai[bedrock]' (or pip install botocore)."
                )
