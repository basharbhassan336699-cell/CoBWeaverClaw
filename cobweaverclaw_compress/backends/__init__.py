"""CoBWeaverClaw Backends - API translation layers for different LLM providers.
...
Usage:
    # LiteLLM backend
    cobweaverclaw_compress proxy --backend litellm-bedrock --region us-west-2

    # any-llm backend
    cobweaverclaw_compress proxy --backend anyllm --anyllm-provider openai
"""
