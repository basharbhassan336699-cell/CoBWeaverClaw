"""Relevance scoring module for CoBWeaverClaw SDK.
...
1. HybridScorer (DEFAULT - recommended)
   ...
   - Install for full support: pip install cobweaverclaw_compress[relevance]
...
3. EmbeddingScorer (requires sentence-transformers)
   ...
   - Install: pip install cobweaverclaw_compress[relevance]
...
Example usage:
    from cobweaverclaw_compress.relevance import HybridScorer, create_scorer
