"""Main CoBWeaverClawClient implementation for CoBWeaverClaw SDK."""
...
class ChatCompletions:
    ...
    def __init__(self, client: CoBWeaverClawClient):
        self._client = client
    ...
    def create(
        ...
        *,
        ...
        stream: bool = False,
        # CoBWeaverClaw-specific parameters
        cobweaverclaw_compress_mode: str | None = None,
        cobweaverclaw_compress_cache_prefix_tokens: int | None = None,
        cobweaverclaw_compress_output_buffer_tokens: int | None = None,
        cobweaverclaw_compress_keep_turns: int | None = None,
        cobweaverclaw_compress_tool_profiles: dict[str, dict[str, Any]] | None = None,
        # Pass through all other kwargs
        **kwargs: Any,
    ) -> Any:
        """
        Create a chat completion with optional CoBWeaverClaw optimization.

        Args:
            model: Model name.
            messages: List of messages.
            stream: Whether to stream the response.
            cobweaverclaw_compress_mode: Override default mode ("audit" | "optimize").
            cobweaverclaw_compress_cache_prefix_tokens: Target cache-aligned prefix size.
            cobweaverclaw_compress_output_buffer_tokens: Reserve tokens for output.
            cobweaverclaw_compress_keep_turns: Never drop last N turns.
            cobweaverclaw_compress_tool_profiles: Per-tool compression config.
        ...
        return self._client._create(
            ...
            messages=messages,
            stream=stream,
            cobweaverclaw_compress_mode=cobweaverclaw_compress_mode,
            cobweaverclaw_compress_cache_prefix_tokens=cobweaverclaw_compress_cache_prefix_tokens,
            cobweaverclaw_compress_output_buffer_tokens=cobweaverclaw_compress_output_buffer_tokens,
            cobweaverclaw_compress_keep_turns=cobweaverclaw_compress_keep_turns,
            cobweaverclaw_compress_tool_profiles=cobweaverclaw_compress_tool_profiles,
            api_style="openai",
            **kwargs,
        )
    ...
    def simulate(
        ...
        *,
        model: str,
        messages: list[dict[str, Any]],
        cobweaverclaw_compress_mode: str = "optimize",
        cobweaverclaw_compress_output_buffer_tokens: int | None = None,
        cobweaverclaw_compress_tool_profiles: dict[str, dict[str, Any]] | None = None,
        **kwargs: Any,
    ) -> SimulationResult:
        ...
        Args:
            model: Model name.
            messages: List of messages.
            cobweaverclaw_compress_mode: Mode to simulate.
            cobweaverclaw_compress_output_buffer_tokens: Output buffer to use.
            cobweaverclaw_compress_tool_profiles: Tool profiles to use.
...
class Messages:
    ...
    def create(
        ...
        **kwargs: Any,
        ...
        """
        Create a message with optional CoBWeaverClaw optimization.
    ...
    def stream(
        ...
        **kwargs: Any,
        ...
        """
        Stream a message with optional CoBWeaverClaw optimization.
...
class CoBWeaverClawClient:
    ...
    def __init__(
        ...
        """
        Initialize CoBWeaverClawClient.
        ...
        Args:
            ...
            config: Optional CoBWeaverClawConfig for full control over all settings.
        ...
        if store_url is None:
            ...
            db_path = os.path.join(tempfile.gettempdir(), "cobweaverclaw_compress.db")
            store_url = f"sqlite:///{db_path}"

        self._store_url = store_url
        self._default_mode = CoBWeaverClawMode(default_mode)
        ...
        if config is not None:
            ...
            self._config = CoBWeaverClawConfig()
            self._config.store_url = store_url
    ...
    def _create(
        ...
        **kwargs: Any,
        ...
        mode = CoBWeaverClawMode(cobweaverclaw_compress_mode) if cobweaverclaw_compress_mode else self._default_mode
        ...
        if mode == CoBWeaverClawMode.OPTIMIZE:
            output_buffer = cobweaverclaw_compress_output_buffer_tokens or self._config.output_buffer_tokens
            ...
            result = self._pipeline.apply(
                ...
                tool_profiles=cobweaverclaw_compress_tool_profiles or {},
            )
    ...
    def __enter__(self) -> CoBWeaverClawClient:
    ...
    def validate_setup(self) -> dict[str, Any]:
        """Validate that CoBWeaverClaw is properly configured.
        ...
        try:
            # Check mode is valid
            if self._default_mode in (CoBWeaverClawMode.AUDIT, CoBWeaverClawMode.OPTIMIZE):
