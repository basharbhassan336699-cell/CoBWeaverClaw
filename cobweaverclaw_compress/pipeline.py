"""Canonical CoBWeaverClaw pipeline lifecycle and extension contracts."""
...
ENTRY_POINT_GROUP = "cobweaverclaw_compress.pipeline_extension"


class PipelineStage(str, Enum):
    """Stable lifecycle stages for the canonical CoBWeaverClaw pipeline."""
