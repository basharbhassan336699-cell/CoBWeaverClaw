"""ONNX Runtime helpers for long-running CoBWeaverClaw processes."""
...
# COBWEAVERCLAW_HF_PIN=off to bypass pinning (e.g. when intentionally evaluating a
...
def create_cpu_session_options(
    ...
    *,
    ...
    CoBWeaverClaw runs as a long-lived proxy process, so we bias toward predictable
