"""Memory evaluation framework for CoBWeaverClaw.
...
Example:
    from cobweaverclaw_compress.evals.memory import LoCoMoEvaluator, MemoryEvalConfig
...
from cobweaverclaw_compress.evals.memory.judge import (
...
from cobweaverclaw_compress.evals.memory.runner import (
    LoCoMoEvaluator,
    MemoryEvalConfig,
    MemoryEvalResult,
...
from cobweaverclaw_compress.evals.memory.runner_v2 import (
    EvalMetrics,
    LoCoMoEvaluatorV2,
    MemoryEvalConfigV2,
    MemoryEvalResultV2,
