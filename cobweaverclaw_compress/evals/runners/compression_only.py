...
class CompressionOnlyRunner:
    ...
    def evaluate_information_retention(
        ...
        """
        from cobweaverclaw_compress.evals.metrics import compute_information_recall
        from cobweaverclaw_compress.transforms.content_router import ContentRouter
    ...
    def evaluate_tool_schema_compaction(
        ...
        *name* under a JSON Schema `properties` object, even if the same key
        ...
        """
        from cobweaverclaw_compress.proxy.handlers.openai import _compact_openai_responses_tools
