"""Adversarial robustness grid for CoBWeaverClaw compressors (offline, no LLM).
...
- abuse compressor control surfaces. CoBWeaverClaw has a concrete instance:
...
# CoBWeaverClaw-specific CCR marker spoof. benign_control anchors the baseline.
