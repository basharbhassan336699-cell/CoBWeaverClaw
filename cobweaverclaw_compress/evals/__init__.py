"""CoBWeaverClaw Evaluation Framework.
...
Install with: pip install cobweaverclaw_compress-ai[evals]

Quick start:
    from cobweaverclaw_compress.evals import run_quick_eval
    results = run_quick_eval(n_samples=5)
    print(results.summary())

Batch compression eval:
    from cobweaverclaw_compress.evals import run_batch_compression_eval
...
from cobweaverclaw_compress.evals.runners.before_after import (
    BeforeAfterRunner,
    LLMConfig,
    run_quick_eval,
)
from cobweaverclaw_compress.transforms.content_router import ContentRouterConfig
