...
from cobweaverclaw_compress.evals.core import EvalCase, EvalSuite
...
def load_tool_output_samples() -> EvalSuite:
    ...
    These are realistic tool outputs that cobweaverclaw_compress is designed to compress:
    - API responses (JSON)
    - Log outputs
    - Code files
                    ...
                    "items": [
                        {
                            ...
                            "full_name": "anthropic/cobweaverclaw_compress",
