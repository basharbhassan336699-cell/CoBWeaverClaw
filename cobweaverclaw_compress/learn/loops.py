"""Loop detection for CoBWeaverClaw Learn — find repeated tool-call patterns.

A *loop* is the single highest-value pattern for `cobweaverclaw_compress learn` to catch,
