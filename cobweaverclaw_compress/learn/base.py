"""Base class for cobweaverclaw_compress learn plugins.
...
class LearnPlugin(ABC):
    ...
    Plugins are discovered automatically from cobweaverclaw_compress.learn.plugins.*
    or via ``cobweaverclaw_compress.learn_plugin`` entry points for external packages.
    ...
    Example::
        ...
        class MyAgentPlugin(LearnPlugin, ConversationScanner):
            ...
            def create_writer(self) -> ContextWriter:
                from cobweaverclaw_compress.learn.writer import GeminiWriter
