"""CoBWeaverClaw Memory - Simple, zero-config memory for AI applications.

Quick Start (No Docker Required):
    from cobweaverclaw_compress.memory import Memory
...
Advanced Usage - LLM Wrapper:
    ...
    from cobweaverclaw_compress.memory import with_memory
...
Advanced Usage - Tool-based:
    from openai import OpenAI
    from cobweaverclaw_compress.memory import with_memory_tools, LocalBackend
...
# Graph adapters
# =============================================================================
from cobweaverclaw_compress.memory.adapters.graph import InMemoryGraphStore
...
# =============================================================================
# Memory Bridge (markdown <-> CoBWeaverClaw bidirectional sync)
# =============================================================================
from cobweaverclaw_compress.memory.bridge import ImportStats, MemoryBridge, SyncStats
from cobweaverclaw_compress.memory.bridge_config import BridgeConfig, MarkdownFormat
from cobweaverclaw_compress.memory.config import (
    EmbedderBackend,
    MemoryConfig,
    StoreBackend,
    TextBackend,
...
# Core orchestrator
# =============================================================================
from cobweaverclaw_compress.memory.core import HierarchicalMemory

# =============================================================================
# Simple API (recommended for most users)
# =============================================================================
from cobweaverclaw_compress.memory.easy import Memory, MemoryResult

# =============================================================================
# Factory
# =============================================================================
from cobweaverclaw_compress.memory.factory import create_memory_system

# =============================================================================
# Data models (internal)
# =============================================================================
from cobweaverclaw_compress.memory.models import Memory as MemoryModel
from cobweaverclaw_compress.memory.models import ScopeLevel

# =============================================================================
# Protocol interfaces (ports)
# =============================================================================
from cobweaverclaw_compress.memory.ports import (
    # Core protocols
    Embedder,
    # Graph dataclasses
    Entity,
...
# =============================================================================
from cobweaverclaw_compress.memory.system import MemoryBackend, MemorySystem

# =============================================================================
# Memory tools for LLM function calling
# =============================================================================
from cobweaverclaw_compress.memory.tools import (
    MEMORY_TOOLS,
...
# =============================================================================
from cobweaverclaw_compress.memory.wrapper import MemoryWrapper, with_memory

# =============================================================================
# Tool-based wrapper for LLM clients
# =============================================================================
from cobweaverclaw_compress.memory.wrapper_tools import MemoryToolsWrapper, with_memory_tools
...
def __getattr__(name: str) -> type:
    ...
    if name == "Mem0Backend":
        if _Mem0Backend is None:
            from cobweaverclaw_compress.memory.backends.mem0 import Mem0Backend
    ...
    if name == "Mem0Config":
        if _Mem0Config is None:
            from cobweaverclaw_compress.memory.backends.mem0 import Mem0Config
    ...
    if name == "DirectMem0Adapter":
        if _DirectMem0Adapter is None:
            from cobweaverclaw_compress.memory.backends.direct_mem0 import DirectMem0Adapter
    ...
    if name == "DirectMem0Config":
        if _DirectMem0Config is None:
            from cobweaverclaw_compress.memory.backends.direct_mem0 import Mem0Config as DirectMem0Config
