...
Writers convert CoBWeaverClaw memory entries into agent-specific file formats.
...
# Marker delimiters for CoBWeaverClaw-managed sections (matches learn/writer.py)
MARKER_START = "<!-- cobweaverclaw_compress:memory:start -->"
MARKER_END = "<!-- cobweaverclaw_compress:memory:end -->"
