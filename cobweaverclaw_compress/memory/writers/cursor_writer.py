...
from cobweaverclaw_compress.memory.writers.base import (
    MARKER_END,
    MARKER_PATTERN,
    MARKER_START,
    AgentWriter,
...
class CursorMemoryWriter(AgentWriter):
    ...
    def default_path(self) -> Path:
        """Default: .cursor/rules/cobweaverclaw_compress-memory.mdc in project root."""
        return self._project_path / ".cursor" / "rules" / "cobweaverclaw_compress-memory.mdc"
    ...
    def export(
        ...
        if target.exists():
            ...
            full_content = (
                "---\n"
                "description: CoBWeaverClaw-learned patterns from proxy traffic\n"
                "alwaysApply: true\n"
                "---\n"
                "\n"
