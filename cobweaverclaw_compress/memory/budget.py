...
This is CoBWeaverClaw's superpower applied to itself — the proxy that optimizes
...
from cobweaverclaw_compress.memory.writers.base import MemoryEntry, _estimate_tokens
