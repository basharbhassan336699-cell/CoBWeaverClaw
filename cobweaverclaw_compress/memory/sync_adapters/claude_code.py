...
Each .md file has:
    ...
    cobweaverclaw_compress_id: <uuid>          (added by sync for cross-reference)
...
class ClaudeCodeAdapter(AgentMemoryAdapter):
            ...
            memories.append(
                AgentMemory(
                    ...
                    metadata={
                        ...
                        "cobweaverclaw_compress_id": fm.get("cobweaverclaw_compress_id", ""),
    ...
    async def write_memories(self, memories: list[dict[str, Any]]) -> int:
        ...
        for mem in memories:
            ...
            cobweaverclaw_compress_id = mem.get("cobweaverclaw_compress_id", "")
            ...
            filename = f"cobweaverclaw_compress_{slug}.md"
            ...
            fm = _build_frontmatter(
                {
                    ...
                    "cobweaverclaw_compress_id": cobweaverclaw_compress_id,
    ...
    def _update_memory_md_index(self, new_entries: list[str]) -> None:
        """Append new entries to MEMORY.md under a CoBWeaverClaw section."""
        memory_md = self._memory_dir / "MEMORY.md"

        section_marker = "## CoBWeaverClaw Shared Memory"
        new_section = f"\n{section_marker}\n" + "\n".join(new_entries) + "\n"
