"""Memory wrapper - the main API for CoBWeaverClaw Memory.

One-line integration with zero-latency inline extraction:
    from cobweaverclaw_compress import with_memory
...
from cobweaverclaw_compress.memory.config import EmbedderBackend, MemoryConfig
from cobweaverclaw_compress.memory.core import HierarchicalMemory
from cobweaverclaw_compress.memory.inline_extractor import (
...
class MemoryWrapper:
    ...
    def __init__(
        ...
        client: Any,
        user_id: str,
        db_path: str | Path = "cobweaverclaw_compress_memory.db",
        top_k: int = 5,
...
class _MemoryAPI:
    ...
    def get_all(self) -> list[Memory]:
        ...
        from cobweaverclaw_compress.memory.ports import MemoryFilter
...
def with_memory(
    ...
    **kwargs: Any,
    ...
    Args:
        ...
        user_id: User identifier for memory isolation
        db_path: Path to SQLite database (default: cobweaverclaw_compress_memory.db)
