"""Local backend adapter for CoBWeaverClaw's hierarchical memory system.
...
from cobweaverclaw_compress.memory.adapters.graph_models import Entity, Relationship, Subgraph
...
class LocalBackend:
    ...
    async def _init_locked(self) -> None:
        ...
        from cobweaverclaw_compress.memory import HierarchicalMemory, MemoryConfig
        from cobweaverclaw_compress.memory.config import EmbedderBackend
    ...
    async def text_search(
        ...
        from cobweaverclaw_compress.memory.ports import TextFilter
