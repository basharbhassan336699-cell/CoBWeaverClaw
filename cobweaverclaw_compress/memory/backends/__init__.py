"""Memory backends for CoBWeaverClaw's hierarchical memory system.
...
def __getattr__(name: str) -> type:
    ...
    if name == "Mem0SystemAdapter":
        if _Mem0SystemAdapter is None:
            from cobweaverclaw_compress.memory.backends.mem0_system_adapter import Mem0SystemAdapter
