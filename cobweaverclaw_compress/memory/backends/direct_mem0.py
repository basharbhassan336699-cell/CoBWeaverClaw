...
Usage:
    from cobweaverclaw_compress.memory.backends.direct_mem0 import DirectMem0Adapter, Mem0Config
    from cobweaverclaw_compress.memory.system import MemorySystem
