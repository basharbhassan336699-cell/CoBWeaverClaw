...
from cobweaverclaw_compress.memory.extraction import EXTRACTION_SYSTEM_PROMPT
from cobweaverclaw_compress.memory.system import MemoryBackend, MemorySystem
from cobweaverclaw_compress.memory.tools import get_memory_tools, get_memory_tools_optimized, get_tool_names
...
def with_memory_tools(
    ...
    Example:
        from openai import OpenAI
        from cobweaverclaw_compress.memory import with_memory_tools
        from cobweaverclaw_compress.memory.backends import LocalBackend
