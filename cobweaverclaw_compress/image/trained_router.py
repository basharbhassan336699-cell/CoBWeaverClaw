...
The MiniLM model is hosted on HuggingFace: cobweaverclaw_compress-ai/technique-router
"""
...
class TrainedRouter:
    ...
    - HuggingFace Hub: cobweaverclaw_compress-ai/technique-router (for production)
    """
