...
come from the environment at cobweaverclaw_compress start-up.
...
class _CopilotQuotaTracker(QuotaTracker):
    ...
    Implements :class:`~cobweaverclaw_compress.subscription.base.QuotaTracker` so it can be
    registered with the :class:`~cobweaverclaw_compress.subscription.base.QuotaTrackerRegistry`.
    ...
    async def _poll_loop(self) -> None:
        ...
        while not self._stop_event.is_set():
            ...
            try:
                ...
                # note in cobweaverclaw_compress/subscription/tracker.py:_poll_loop.
