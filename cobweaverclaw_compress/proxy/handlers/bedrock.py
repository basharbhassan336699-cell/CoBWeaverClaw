"""AWS Bedrock ``InvokeModel`` passthrough handler for CoBWeaverClawProxy.
...
through CoBWeaverClaw's catch-all and were forwarded verbatim — no compression.
...
class BedrockHandlerMixin:
    ...
    async def handle_bedrock_invoke(
        ...
        *,
        ...
        bypass = (
            _cobweaverclaw_compress_bypass_enabled(request.headers)
