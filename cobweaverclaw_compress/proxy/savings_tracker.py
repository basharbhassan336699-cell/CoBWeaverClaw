...
survive proxy restarts and can be shared by multiple CoBWeaverClaw frontends.
"""
...
COBWEAVERCLAW_SAVINGS_PATH_ENV_VAR = _paths.COBWEAVERCLAW_SAVINGS_PATH_ENV
DEFAULT_SAVINGS_DIR = ".cobweaverclaw_compress"
...
def get_default_savings_storage_path() -> str:
    ...
    # Preserve legacy behavior: when COBWEAVERCLAW_SAVINGS_PATH is set we return
    ...
    env_path = os.environ.get(COBWEAVERCLAW_SAVINGS_PATH_ENV_VAR, "").strip()
    if env_path:
        return env_path
...
class SavingsTracker:
    ...
    def __init__(
        ...
        # writes proxy_savings.json (honors CoBWeaverClawConfig.stateless, which
