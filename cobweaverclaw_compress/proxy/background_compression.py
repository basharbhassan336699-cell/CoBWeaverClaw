...
(``CoBWeaverClawProxy._compression_caches``), and multi-worker deployments are
...
class BackgroundCompressor:
    ...
    async def start(self) -> None:
        if self._task is None or self._task.done():
            self._task = asyncio.create_task(self._drain(), name="cobweaverclaw_compress-bg-compress")
