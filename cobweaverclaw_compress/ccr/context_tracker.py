...
class ContextTracker:
    ...
    def format_expansions_for_context(
        ...
        *,
        ...
        body = body.replace("</cobweaverclaw_compress_proactive_expansion>", "<\\/cobweaverclaw_compress_proactive_expansion>")
        return f"<cobweaverclaw_compress_proactive_expansion>\n{body}\n</cobweaverclaw_compress_proactive_expansion>"
