...
Four key components:
1. Tool Injection: Proxy injects cobweaverclaw_compress_retrieve tool into requests
...
try:
    from .mcp_server import CoBWeaverClawMCPServer, create_ccr_mcp_server

    MCP_SERVER_AVAILABLE = True
except ImportError:
    CoBWeaverClawMCPServer = None  # type: ignore
