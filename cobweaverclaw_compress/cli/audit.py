...
def audit_reads_cmd(
    ...
    \b
    Examples:
        cobweaverclaw_compress audit-reads
        cobweaverclaw_compress audit-reads --path /var/transcripts --format json
        cobweaverclaw_compress audit-reads --codex
    """
    import json as _json

    from cobweaverclaw_compress.audit.reads import audit_reads, render_text
    ...
    if codex_mode:
        ...
        from cobweaverclaw_compress.audit.codex import audit_codex, render_codex_text
    ...
    if simulate_maturation:
        from cobweaverclaw_compress.audit.maturation import render_sim_text
        from cobweaverclaw_compress.audit.maturation import simulate_maturation as run_sim
