...
from cobweaverclaw_compress.cli.main import main
from cobweaverclaw_compress.copilot_auth import (
    DEFAULT_GITHUB_HOST,
    cobweaverclaw_compress_copilot_auth_path,
    poll_copilot_device_authorization,
    read_cobweaverclaw_compress_copilot_oauth_token,
    save_cobweaverclaw_compress_copilot_oauth_token,
...
def copilot_auth() -> None:
    """Manage CoBWeaverClaw's GitHub Copilot OAuth token."""
...
def login(domain: str) -> None:
    ...
    path = save_cobweaverclaw_compress_copilot_oauth_token(token, domain=domain)
...
def status() -> None:
    """Show whether CoBWeaverClaw has a saved Copilot OAuth token."""

    token = read_cobweaverclaw_compress_copilot_oauth_token()
