...
Automatically detects the correct CoBWeaverClaw provider based on the Strands model type.
"""
...
# Mapping from Strands model class names to CoBWeaverClaw providers
...
def get_cobweaverclaw_compress_provider(model: Any) -> Provider:
    """Get the appropriate CoBWeaverClaw provider for a Strands model.
    ...
    Example:
        ...
        from cobweaverclaw_compress.integrations.strands.providers import get_cobweaverclaw_compress_provider
