...
Automatically detects the correct CoBWeaverClaw provider based on the Agno model type.
"""
...
# Mapping from Agno model class names to CoBWeaverClaw providers
...
def get_cobweaverclaw_compress_provider(agno_model: Any) -> Provider:
    """Get the appropriate CoBWeaverClaw provider for an Agno model.
    ...
    Returns:
        Appropriate CoBWeaverClaw Provider instance.

    Example:
        from agno.models.openai import OpenAIChat
        from cobweaverclaw_compress.integrations.agno.providers import get_cobweaverclaw_compress_provider

        model = OpenAIChat(id="gpt-4o")
        provider = get_cobweaverclaw_compress_provider(model)  # Returns OpenAIProvider
    """
