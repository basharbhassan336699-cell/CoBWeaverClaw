"""LangGraph integration for CoBWeaverClaw tool message compression.
...
Example:
    ...
    from cobweaverclaw_compress.integrations.langchain.langgraph import (
...
def compress_tool_messages(
    ...
    *,
    ...
    Example:
        ...
        from cobweaverclaw_compress.integrations.langchain.langgraph import compress_tool_messages
