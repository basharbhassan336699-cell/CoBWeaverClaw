...
This module provides CoBWeaverClawChatMessageHistory, a wrapper for any LangChain
...
Example:
    ...
    from cobweaverclaw_compress.integrations import CoBWeaverClawChatMessageHistory

    # Wrap any chat message history
    base_history = ChatMessageHistory()
    compressed_history = CoBWeaverClawChatMessageHistory(base_history)
...
if TYPE_CHECKING:
    from cobweaverclaw_compress.providers.base import Provider
...
class CoBWeaverClawChatMessageHistory(BaseChatMessageHistory):
    ...
    Example:
        ...
        compressed = CoBWeaverClawChatMessageHistory(
            base,
    ...
    def __init__(
        ...
        """Initialize CoBWeaverClawChatMessageHistory.
        ...
        Args:
            ...
            model: Model name for token counting. Default "gpt-4o".
            provider: CoBWeaverClaw provider for token counting. Auto-uses
    ...
    def messages(self) -> list[BaseMessage]:  # type: ignore[override]
        ...
        logger.info(
            f"CoBWeaverClawChatMessageHistory compressed: {token_count} -> {tokens_after} tokens "
    ...
    def _apply_compression(self, messages: list[BaseMessage]) -> list[BaseMessage]:
        ...
        Returns:
            ...
            applicable.
        """
        # Convert to OpenAI format for CoBWeaverClaw transforms
