...
This module provides CoBWeaverClawDocumentCompressor, a LangChain BaseDocumentCompressor
...
Example:
    ...
    from cobweaverclaw_compress.integrations import CoBWeaverClawDocumentCompressor
    ...
    compressor = CoBWeaverClawDocumentCompressor(max_documents=10)
...
class CoBWeaverClawDocumentCompressor(BaseDocumentCompressor):
    ...
    Example:
        ...
        compressor = CoBWeaverClawDocumentCompressor(
            max_documents=10,
            min_relevance=0.3,
        )
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """Initialize CoBWeaverClawDocumentCompressor.
    ...
    def compress_documents(
        ...
        logger.info(
            f"CoBWeaverClawDocumentCompressor: {len(documents)} -> {len(final_docs)} documents "
