...
Example:
    ...
    from cobweaverclaw_compress.integrations import CoBWeaverClawChatModel, StreamingMetricsTracker
...
class StreamingMetricsTracker:
    ...
    def __init__(
        ...
        Args:
            ...
            provider: CoBWeaverClaw provider for token counting. Uses
...
class StreamingMetricsCallback:
    ...
    def __init__(self, model: str = "gpt-4o", provider: Any = None):
        ...
        Args:
            model: Model name for token counting.
            provider: CoBWeaverClaw provider for token counting.
        """
