...
See the ``cobweaverclaw-agent-dev`` skill (``references/self-improvement-loop.md``)
...
from memory.core._compat import thread_scoped_silence
...
_SKILL_REVIEW_PROMPT = (
    ...
    "  • Bundled skills (shipped with CoBWeaverClaw, e.g. 'cobweaverclaw-agent').\n"
    "  • Hub-installed skills (installed via 'cobweaverclaw skills install').\n"
    "Pinned skills (marked via 'cobweaverclaw curator pin') CAN be improved — "
...
def build_memory_write_metadata(
    ...
    *,
    ...
    metadata: Dict[str, Any] = {
        ...
        "platform": agent.platform or os.environ.get("COBWEAVERCLAW_SESSION_SOURCE", "cli"),
        "tool_name": "memory",
    }
    if task_id:
...
def _run_review_in_thread(
    ...
    try:
        ...
        with thread_scoped_silence():
            ...
            # scratch (fresh _cobweaverclaw_now() timestamp, fresh
            ...
            from cobweaverclaw_cli.plugins import (
