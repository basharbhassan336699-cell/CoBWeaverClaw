...
import { formatErrorMessage } from "cobweaverclaw/plugin-sdk/error-runtime";
import type { MemorySource } from "cobweaverclaw/plugin-sdk/memory-core-host-engine-storage";
import {
  asToolParamsRecord,
  jsonResult,
  ...
  type CoBWeaverClawConfig,
} from "cobweaverclaw/plugin-sdk/memory-core-host-runtime-core";
import type {
  MemorySearchResult,
  MemorySearchRuntimeDebug,
} from "cobweaverclaw/plugin-sdk/memory-core-host-runtime-files";
import {
...
const PAUSED_MEMORY_INDEX_ACTION =
  "Tell the user to run: cobweaverclaw memory status --index or cobweaverclaw memory index --force.";
...
export function createMemorySearchTool(options: {
  ...
  getConfig?: () => CoBWeaverClawConfig | undefined;
  agentId?: string;
  agentSessionKey?: string;
  sandboxed?: boolean;
